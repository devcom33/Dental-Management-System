...
$(document).ready(function () {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        events:'/assistant/fullcalender/$id_Assistant/$fk_Doctor',
        selectable:true,
        selectHelper: true,
        select:function(start, end, allDay)
        {
            ...
            if(title)
            {
                ...
                $.ajax({
                    url:"/assistant/fullcalenderAjax",
                    type:"POST",
                    data:{
                        status: title,
                        start: start,
        ...
        eventRender: function(event, element) {
            // To append if is description in next line
              ...
              //  if (event.fk_doctor==2&&event.fk_assistance==1) {
          ...
          <form method="post" action="{{ route('fullcalender.store') }}" >
            <div class="modal-body">
                ...
                <div class="mb-3" >
                    ...
                    <div class="mb-3">
                        <select name="as" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                          {{-- <option selected>Doctor</option> --}}
