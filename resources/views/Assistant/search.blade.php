           ...
           <td>{{$value->id_patient}}</td>
            ...
            <td>
                <form  action="{{ route('assistant.destroy',$value->id_patient) }}" method="POST">   
                    ...
                    @method('DELETE') 
                     <!-- Button Show -->
                    <a class="btn btn-info" href="{{ route('assistant.show',$value->id_patient) }}">Show</a> 
                    <!-- Button Edit -->   
                    <a class="btn btn-primary" href="{{ route('assistant.edit',$value->id_patient) }}" data-bs-toggle="modal" data-bs-target="#exampleModal1{{$value->id_patient}}">Edit</a>
                    <!-- Button Delete -->        
